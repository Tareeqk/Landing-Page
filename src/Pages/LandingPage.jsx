...
export default function LandingPage() {
  ...
  const scrollToDownload = () => {
    if (downloadRef.current) {
      const y =
        downloadRef.current.getBoundingClientRect().top + window.scrollY - 100
  ...
  return (
    <>
      ...
      <div className="relative w-full h-auto py-4 md:py-6 overflow-x-hidden landing-container">
        {" "}
        {/* Keep overflow-x-hidden */}
        {/* Background */}
        <div className="absolute inset-x-0 top-0 bottom-0 z-0 h-full overflow-x-hidden">
          {" "}
          {/* Changed to h-full, removed overflow-hidden */}
          <img
            src="/new/NewBG2.webp"
        ...
        <div className="relative z-10 flex items-center h-auto min-h-screen">
          ...
          <div className="max-w-screen-xl mx-auto px-4 md:px-6 grid grid-cols-1 mt-10 lg:grid-cols-2 gap-4 md:gap-6">
            ...
            <div
              data-aos="fade-left"
              className="flex justify-center items-center order-1 lg:order-2 lg:items-end"
            >
              <img
      ...
      <div
        ref={downloadRef}
        className="w-full overflow-x-hidden download-apps-container bg-[var(--secondary-light-gray)] dark-bg py-10 px-4"
        id="target-section"
      >

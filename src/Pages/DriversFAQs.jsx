...
export default function DriversFAQs() {
  ...
  useEffect(() => {
    async function fetchDriversFAQs() {
      const response = await axios.get(
        `${baseUrl}/pages?slug=drivers-faqs&lang=${i18n.language}`
      );
  ...
  <Helmet>
          ...
          <link rel="canonical" href={`https://tareeqk.ae/${lang}/drivers-FAQs`} />
        </Helmet>
            ...
            >
              ...
              <div
                className={`transition-max-h duration-400 overflow-hidden ${
                  openIndexs.includes(idx) ? "max-h-96" : "max-h-0"
                }`}
              >
                <div

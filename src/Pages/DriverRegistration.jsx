    ...
    <>
        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-sm sm:text-base">
              {t("driverRegistration.hero.features")}
            </span>
          </div>
        </div>
      </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            {t("driverRegistration.benefits.title")}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((item, index) => (
              <div
                key={index}
                className="bg-[var(--secondary-light-gray)] dark-bg text-center p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow"
                data-aos="fade-up"
      ...
      <div className="container mx-auto px-4 py-12 rounded-lg my-8">
        <div data-aos="fade-up" className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-2 text-gray-800">
            {t("driverRegistration.process.title")}
          </h2>
          <p className="text-center text-gray-400 mb-8">
            {t("driverRegistration.process.subtitle")}
          </p>

          <div
            className="dark-bg text-gray-400 rounded-xl shadow-md p-6 mb-8"
            data-aos="fade-up"
          >
            ...
            <div className="bg-gray-200 p-4 rounded-lg mb-6">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {t("driverRegistration.process.requirements", {
                  returnObjects: true,
                }).map((req, index) => (
            ...
            <h3 className="text-xl font-semibold mb-4 flex items-center text-gray-800">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 mr-2 text-yellow-500 d-flex align-items-center"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <ol className="list-decimal list-inside mb-6 space-y-3 span-titles text-gray-500">
              {t("driverRegistration.process.steps", {
                returnObjects: true,
              }).map((step, index) => (
            ...
            <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
              <p className="text-gray-800 flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 mr-2 flex-shrink-0 text-yellow-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
      ...
      <section className="py-12 bg-[var(--secondary-light-gray)] dark-bg text-gray-700">
        <div className="container mx-auto px-4 text-center">
          <h2 data-aos="fade-up" className="text-3xl font-bold mb-4">
            {t("driverRegistration.cta.title")}
          </h2>
          <p
            data-aos="fade-up"
            className="text-xl mb-8 max-w-2xl mx-auto span-titles"
          >
            {t("driverRegistration.cta.subtitle")}
          </p>

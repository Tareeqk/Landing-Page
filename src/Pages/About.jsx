      ...
      <section id={1}>
        <div className="container mx-auto px-4 my-8">
          ...
          <div className="md:col-span-2" data-aos="fade-right">
            <HeadingTag
              className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium max-w-4xl ${isUrdu ? "leading-loose" : "leading-tight"}`}
            >
              {t("about.title")}
            </HeadingTag>
            <h4
              className={`subtitle text-md sm:text-xs md:text-sm lg:text-xl max-w-xl text-gray-600 mt-5 ${isUrdu ? "leading-loose" : "leading-tight"}`}
            >
              {t("about.subtitle")}
            </h4>
                ...
                <Trans
                  ...
                  components={{
                    1: (
                      <a
                        key="about-link"
                        href="https://www.tareeqk.ae/service"
            ...
            <div className="flex flex-wrap justify-evenly gap-4 mt-6">
              <b
                className={`text-sm md:text-base ${isUrdu ? "leading-loose" : ""}`}
              >
                {" "}
      ...
      <section id={2} className="my-20 overflow-x-hidden">
        <div className="container mx-auto px-4">
          <div className="mb-6" data-aos="fade-right">
            ...
            <h2
              className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium mb-4 ${isUrdu ? "leading-loose" : ""}`}
            >
              {t("about2.title")}
            </h2>

            <p
              className={`text-gray-400 mb-8 ${isUrdu ? "leading-loose" : ""}`}
            >
              {t("about2.subtitle")}
          ...
          <div className="flex flex-col xl:flex-row gap-6">
            <div
              data-aos="fade-right"
              className="flex flex-col gap-4 w-full xl:w-1/2"
            >
              {[
                {
                  icon: "Road",
                  alt: "Roadside Assistance in Dubai",
                  title: "about2.item1title",
                  subtitle: "about2.item1subtitle",
                },
                {
                  icon: "Towing",
                  alt: "Towing Service in Dubai",
                  title: "about2.item2title",
                  subtitle: "about2.item2subtitle",
                },
                {
                  icon: "User",
                  alt: "Desert Recovery in Dubai",
                  title: "about2.item3title",
                  subtitle: "about2.item3subtitle",
                },
              ].map((item, i) => (
                <div
                  key={i}
                ...
                >
                  <div className="flex gap-3 items-center">
                    ...
                    <div>
                      <h3
                        className={`text-base md:text-xl font-semibold text-black ${isUrdu ? "leading-loose" : ""}`}
                      >
                        {t(item.title)}
                      </h3>
                      <p
                        className={`text-gray-400 text-sm ${isUrdu ? "leading-loose" : ""}`}
                      >
                        {t(item.subtitle)}
                      </p>
                    </div>

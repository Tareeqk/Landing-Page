      ...
      <div className="mx-auto px-4 my-8 container">
        ...
        <div className="bg-[var(--secondary-light-gray)] dark-bg py-4 px-4 md:py-6 md:px-6 rounded-xl overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-8">
            {/* Steps List */}
            <div
              className="w-full lg:w-1/2 space-y-4 flex flex-col"
              data-aos="fade-right"
            >
              ...
              <div className="pt-4 mt-auto">
                <button
                  ...
                  className="cursor-pointer getTow-btn px-5 py-2 sm:px-6 sm:py-3 bg-[var(--primary-dark-bg)] hover:bg-black text-white font-medium rounded-lg transition-all duration-300 hover:-translate-y-0.5 text-sm sm:text-base"
                >
                  {t("howItWorks.cta")}
                </button>
              </div>

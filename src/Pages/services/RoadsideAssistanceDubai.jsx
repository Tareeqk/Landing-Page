...
// term (battery/tyre/lockout/recovery collectively), positioned
...
const config = {
  ...
  metaDesc: 'Need roadside assistance in Dubai? Tareeqk offers 24/7 emergency help — battery boost, flat tyre, lockouts, and recovery. Call or WhatsApp now.',
  title: 'Roadside Assistance in Dubai',
  heroImage: '/new/Recovery_Van.webp',
  heroAlt: 'Roadside Assistance Dubai',
  intro: 'Stuck with a dead battery, flat tyre, or locked out? Tareeqk\'s 24/7 roadside assistance covers every kind of breakdown in Dubai — one call gets you a certified technician, fast.',
  ...
  whyUs: [
    'One number for every roadside problem — battery, tyre, lockout, or full recovery.',
  ...
  faqs: [
    {
      ...
      a: 'Any on-the-spot help for a stranded vehicle — battery jump-starts, flat tyre changes, lockout assistance, and full car recovery if your vehicle can\'t be fixed on-site.',
    },
    {
    ...
    },
    {
      ...
      a: 'Many issues — dead batteries, flat tyres, lockouts — are resolved on-site. If the problem needs a workshop, we arrange recovery to a garage of your choice instead.',
    },
    {
  ...
  schemaDesc: '24/7 roadside assistance in Dubai covering battery jump-starts, flat tyre repair, lockout help, and full vehicle recovery.',
};

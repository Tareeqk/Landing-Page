...
export function CarRecoveryDubaiMarina() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Dubai Marina. Tareeqk dispatches within 15 minutes, 24/7. Call or WhatsApp for instant help.',
      ...
      faqs: [
        { q: 'How fast can you reach Dubai Marina?', a: 'Our average response time to Dubai Marina is 15 minutes. We have units positioned in the surrounding area for rapid dispatch.' },
...
export function CarRecoveryBusinessBay() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Business Bay Dubai. 15-minute response, 24/7 availability. Call or WhatsApp Tareeqk now.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'Business Bay is centrally located, which means our nearest unit is usually only minutes away. We navigate the area\'s busy roads and underground facilities efficiently, targeting a 15-minute response time.',
      faqs: [
        ...
        { q: 'How fast is car recovery in Business Bay?', a: 'Average response time is 15 minutes. Business Bay\'s central location means we often reach you faster.' },
...
export function CarRecoveryDowntownDubai() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Downtown Dubai. Tareeqk reaches Burj Khalifa, Dubai Mall and DIFC areas in 15 minutes, 24/7.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      faqs: [
        ...
        { q: 'How fast can Tareeqk reach Downtown Dubai?', a: 'Our average response time in Downtown Dubai is 15 minutes, even with the area\'s heavy traffic and one-way systems.' },
  ...
  return (
    <LocationPageTemplate config={{
      ...
      faqs: [
        ...
        { q: 'How quickly can you reach me in Deira?', a: 'Our average response time in Deira is 15 minutes. Traffic permitting, we often arrive faster.' },
...
export function CarRecoveryBurDubai() {
  return (
    <LocationPageTemplate config={{
      ...
      responseDesc: 'Our drivers know Bur Dubai\'s older street layout, from Al Mankhool to Oud Metha, and can navigate narrow lanes and souk traffic to reach you in around 15 minutes.',
      faqs: [
        ...
        { q: 'How quickly can you reach Bur Dubai?', a: 'Average response time is 15 minutes, accounting for Bur Dubai\'s narrower streets and souk-area traffic.' },
...
export function CarRecoveryAlBarsha() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Al Barsha, Dubai. Covering Al Barsha 1, 2, 3 and Mall of the Emirates area. 15-minute response.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'Positioned close to Sheikh Zayed Road, our units can reach most Al Barsha addresses — including the areas around Mall of the Emirates — within 15 minutes.',
      faqs: [
        ...
        { q: 'How fast can you reach Al Barsha?', a: 'Our average response time in Al Barsha is 15 minutes thanks to our Sheikh Zayed Road positioning.' },
...
export function CarRecoveryJumeirah() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Jumeirah, Dubai. 24/7 service, 15-minute response. Covering Jumeirah 1, 2, 3, and surrounding areas.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'Jumeirah\'s straight coastal roads and well-mapped streets allow our team to navigate quickly. We dispatch the nearest available unit to your location in Jumeirah and typically arrive within 15 minutes.',
      faqs: [
        ...
        { q: 'How fast can you reach Jumeirah?', a: 'Our average response time in Jumeirah is 15 minutes. Jumeirah\'s clear road layout helps our team reach you efficiently.' },
...
export function CarRecoveryJVC() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in JVC Dubai. Fast 15-minute response, 24/7 service. Call or WhatsApp Tareeqk for immediate help.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'JVC\'s circular internal roads can be confusing. Share your GPS pin via the Tareeqk app or WhatsApp and our team will navigate directly to you — typically arriving within 15 minutes.',
      faqs: [
        ...
        { q: 'How quickly can Tareeqk reach JVC?', a: 'Our average response time in JVC is 15 minutes. We have units in the Al Barsha and surrounding areas ready to dispatch.' },
...
export function CarRecoveryJLT() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in JLT Dubai. Covering all clusters around the lakes. 15-minute response, 24/7 service.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'We know JLT\'s cluster numbering system and basement parking layouts, so our team can locate your tower quickly — typically arriving within 15 minutes.',
      faqs: [
        ...
        { q: 'How fast can Tareeqk reach JLT?', a: 'Our average response time in JLT is 15 minutes, with units positioned nearby in Dubai Marina and JVC.' },
...
export function CarRecoveryDubaiSiliconOasis() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Dubai Silicon Oasis. Covering DSO residential and tech park zones. 15-minute response, 24/7.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'DSO\'s wide layout means slightly longer travel distances, but our units cover the area regularly — reaching most locations within 15 minutes.',
      faqs: [
        ...
        { q: 'How long does it take to reach Dubai Silicon Oasis?', a: 'Our average response time is 15 minutes due to DSO\'s wider road network.' },
...
export function CarRecoveryInternationalCity() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in International City, Dubai. Covering all country clusters and Dragon Mart. 15-minute response.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'Share your cluster name and building number, or drop a GPS pin, and our team will navigate directly to you — usually within 15 minutes.',
      faqs: [
        ...
        { q: 'How fast can you reach International City?', a: 'Our average response time is 15 minutes given the area\'s size and distance from central Dubai.' },
...
export function CarRecoveryDIP() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Dubai Investment Park (DIP). Covering DIP 1 and 2, residential and industrial zones. 15-minute response.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'Given DIP\'s distance from central Dubai, we aim for a 15-minute response, with units that regularly service the surrounding Jebel Ali and Expo corridor.',
      faqs: [
        ...
        { q: 'How long does recovery take in DIP?', a: 'Our average response time is 15 minutes due to the area\'s distance from central Dubai.' },
...
export function CarRecoveryDubaiSportsCity() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Dubai Sports City. Covering all residential towers and stadium areas. 15-minute response, 24/7.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'We track event schedules around the stadiums to plan routes accordingly, generally reaching Dubai Sports City addresses within 15 minutes.',
      faqs: [
        ...
        { q: 'How fast can you reach Dubai Sports City?', a: 'Average response time is 15 minutes, slightly longer on event days due to stadium traffic.' },
...
export function CarRecoveryMotorCity() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Motor City, Dubai. Covering Green Community and Dubai Autodrome areas. 15-minute response.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'Our units regularly service the Motor City and Sports City corridor, reaching most addresses within 15 minutes, including evenings around track-day events.',
      faqs: [
        ...
        { q: 'How fast can you reach Motor City?', a: 'Our average response time is 15 minutes for Motor City addresses.' },
...
export function CarRecoveryMirdif() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Mirdif, Dubai. Covering all Mirdif villa communities and Mirdif City Centre. 15-minute response.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'We keep units positioned to serve eastern Dubai communities like Mirdif, typically reaching villa addresses or the City Centre area within 15 minutes.',
      faqs: [
        { q: 'Do you cover all Mirdif villa communities?', a: 'Yes, we cover all of Mirdif\'s residential streets and villa clusters.' },
        { q: 'How fast can you reach Mirdif?', a: 'Our average response time in Mirdif is 15 minutes, given its distance from central Dubai.' },
...
export function CarRecoveryAlQusais() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Al Qusais, Dubai. Covering residential and industrial zones near Sharjah border. 15-minute response.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      responseDesc: 'Our team knows Al Qusais\' mix of residential streets and industrial roads well, and typically reaches you within 15 minutes regardless of which side of the district you\'re on.',
      faqs: [
        ...
        { q: 'How fast can you reach Al Qusais?', a: 'Our average response time in Al Qusais is 15 minutes.' },
...
export function CarRecoveryAlQuoz() {
  return (
    <LocationPageTemplate config={{
      ...
      metaDesc: 'Car recovery and roadside assistance in Al Quoz, Dubai. 15-minute response, 24/7. Covering Al Quoz Industrial, Al Quoz 1, 2, 3, 4.',
      heroImage: '/new/Recovery_Van.webp',
      ...
      faqs: [
        ...
        { q: 'How fast can you reach Al Quoz?', a: 'Our average response time to Al Quoz is 15 minutes. The area\'s central location often means faster arrival.' },
...
export function CarRecoveryJebelAli() {
  return (
    <LocationPageTemplate config={{
      ...
      responseDesc: 'Given Jebel Ali\'s size and distance from the city centre, we aim for a 15-minute response, with units that regularly cover the wider Jebel Ali–DIP corridor.',
      faqs: [
        ...
        { q: 'How long does recovery take in Jebel Ali?', a: 'Our average response time is 15 minutes due to the area\'s scale and distance from central Dubai.' },
...
export function CarRecoveryPalmJumeirah() {
  return (
    <LocationPageTemplate config={{
      ...
      responseDesc: 'We monitor traffic on the Palm\'s access bridge and plan routes accordingly, generally reaching Trunk and Frond addresses within 15 minutes.',
      faqs: [
        { q: 'Do you cover all the Fronds on Palm Jumeirah?', a: 'Yes, we cover every Frond, the Trunk, and the outer Crescent resorts.' },
        { q: 'How fast can you reach Palm Jumeirah?', a: 'Our average response time is 15 minutes, accounting for the single access road onto the island.' },
